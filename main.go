...
import (
	...
	//hystrix2 "github.com/conding/router/plugin/hystrix"
	"strconv"
)
...
func main() {
	...
	//4.添加链路追踪
	//t, io, err := common.NewTracer("go.micro.service.router", tracerHost+":"+strconv.Itoa(tracerPort))
	//if err != nil {
	//	common.Error(err)
	//}
	//defer io.Close()
	...
	service := micro.NewService(
		...
		micro.Name("go.micro.service.router"),
	...
	router.RegisterRouterHandler(service.Server(), &handler.RouterHandler{RouterDataService: routerDataService})
